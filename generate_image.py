# server/generate_image.py
from setup_sd_pipeline import setup_pipeline
from image_utils import decode_base64_image, encode_image  # Updated import
from control_net_utils import CONTROLNET_MAPPING  # Updated import
...
def generate_image(base_request: BaseSDRequest, req_id):
    ...
    # send the path of the last image
    return final_image_path


from file_utils import delete_image_file  # Updated import
...
def main():
    ...
    from image_utils import encode_image  # Updated import
